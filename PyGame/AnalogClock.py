...
def print_text(font, x, y, text, color=(0,180,180)):
...
while True:
    ...
    hour_x = math.cos( hour_angle ) * (radius-40)
    ...
    min_y = math.sin( min_angle ) * (radius-40)
    ...
    sec_x = math.cos( sec_angle ) * (radius-60)
    sec_y = math.sin( sec_angle ) * (radius-60)
