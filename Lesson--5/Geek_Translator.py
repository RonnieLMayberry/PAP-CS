...
geek = {"404": "clueless. From the web error 404, meaning page not found.",
        ...
        "Link Rot": "the process by which web page linnks become obsolete.",
        "Percussive Maintainence": "the act of striking an electronic device to make it work.",
